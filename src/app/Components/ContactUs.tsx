...
const ContactUs = () => {
    ...
    const sendEmail = (e: any) => {
        ...
        emailjs.send('service_xvky2xu', 'template_bka962h', formData, 'hi59VryflWEbODe1a')
            .then((result) => {
  ...
  return ( <div className="font-[sans-serif]  mx-auto relative bg-gray-300 rounded-lg py-6">
    <div className="grid lg:grid-cols-3 items-center">
        <div className="grid  gap-4 z-20 relative lg:left-16 max-lg:px-4">
            ...
            <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                ...
                <h4 className="text-gray-800 text-base font-bold mt-4">Contact to us</h4>
